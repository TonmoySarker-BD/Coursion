...
const CourseCard = ({ course}) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
      className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 transition"
    ...
    >
      ...
      <div className="relative">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute bottom-3 right-3 bg-success  text-xs font-bold px-2 py-1 rounded-full flex items-center">
